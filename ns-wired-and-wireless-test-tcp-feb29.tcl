...
set opt(y)              800  
set opt(ifqlen)         50   
set opt(tr)          ns-wired-and-wireless-DSDV-TCP-feb29.tr
set opt(namtr)       ns-wired-and-wireless-DSDV-TCP-feb29.nam
set opt(nn)             6                       
