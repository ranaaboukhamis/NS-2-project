...
set opt(y)              800  
set opt(ifqlen)         50   
set opt(tr)          ns-wired.tr
set opt(namtr)       ns-wired.nam
set opt(nn)             6                       
...
#Set Queue Size of link (n3-n5) to 150
$ns_ queue-limit $W(3) $W(5) 50
$ns_ duplex-link $W(4) $W(5) 5Mb 0.5ms DropTail
#Set Queue Size of link (n4-n5) to 150 
...
#Set Queue Size of link (n8-n5) to 150
...
$ns_ attach-agent $W(4) $tcp(2)
$ns_ attach-agent $W(9) $sink(2)
...
$ns_ attach-agent $W(2) $tcp(3)
$ns_ attach-agent $W(5) $sink(3)
...
$ns_ attach-agent $W(0) $sink(7)
$ns_ connect $tcp(7) $sink(7)
set ftp(7) [new Application/FTP]
$ftp(7) attach-agent $tcp(7)

$ns_ attach-agent $W(4) $tcp(8)
$ns_ attach-agent $W(1) $sink(8)
