...
set opt(y)              670   
set opt(ifqlen)         50   
set opt(tr)          ns-wired-and-wireless-DSDV-TCP-feb24.tr
set opt(namtr)       ns-wired-and-wireless-DSDV-TCP-feb24.nam
set opt(nn)             6                       
...
$ns_ rtmodel-at 5.5 up $W(1) $W(4)
  ...
  $ns_ connect $tcp2 $sink1
  set ftp2 [new Application/FTP]
  $ftp2 attach-agent $tcp2
  #$ns_ at 0.5 "$ftp2 start"
  $ns_ at 0.5 "$node_(0) color green"
  $node_(0) color "green"
...
$ns_ at 3.0 "$node_(2) color pink"
$node_(2) color "pink"
$ns_ at 3.0 "$node_(5) color brown"
$node_(5) color "brown"


set tcp5 [new Agent/TCP]
$ns_ attach-agent $W(9) $tcp5
#set sink3 [new Agent/TCPSink]
#$ns_ attach-agent $node_(2) $sink3
$ns_ connect $tcp5 $sink1
...
$node_(2) color "blue"
$ns_ at 0.0 "$node_(5) color orange"
$node_(5) color "orange"
...
$ns_ attach-agent $W(5) $null_(1)

set cbr_(1) [new Application/Traffic/CBR]
$cbr_(1) set packetSize_ 512
$cbr_(1) set interval_ 0.05
$cbr_(1) set random_ 1
$cbr_(1) set maxpkts_ 1600
